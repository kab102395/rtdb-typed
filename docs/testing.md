...
Until that upstream capability exists and is verified, Layer 1 and Layer 2 should be the normal test path. Do not point automated tests at a real Firebase RTDB instance as a workaround.
